...
(function () {
  ...
  /* ---------- stili ---------- */
  var css = ''
    + '#rexo-cookie{position:fixed;left:18px;right:18px;bottom:18px;z-index:1500;'
    + 'max-width:520px;margin-inline:auto;background:#0E0E0E;color:#F2F2F2;'
    + 'border:1px solid rgba(255,255,255,.22);border-radius:16px;padding:26px;'
    + 'font-family:Poppins,system-ui,sans-serif;font-size:.88rem;line-height:1.55;'
    + 'box-shadow:0 30px 80px rgba(0,0,0,.7);transform:translateY(24px);opacity:0;'
    ...
    + '#rexo-cookie p{margin:0 0 16px;color:#9B9B9B}'
    + '#rexo-cookie a{color:#fff;text-decoration:underline}'
    + '.rexo-c-row{display:flex;gap:10px;flex-wrap:wrap}'
    ...
    + 'padding:11px 20px;cursor:pointer;border:none;background:#fff;color:#000}'
    + '.rexo-c-btn.ghost{background:transparent;color:#F2F2F2;border:1px solid rgba(255,255,255,.3)}'
    + '.rexo-c-btn.link{background:none;border:none;color:#9B9B9B;text-decoration:underline;padding:11px 6px}'
    ...
    + '.rexo-c-opt{display:flex;align-items:flex-start;justify-content:space-between;'
    ...
    + '.rexo-c-opt input{width:18px;height:18px;accent-color:#fff;margin-top:4px;flex-shrink:0;cursor:pointer}'
    + '.rexo-c-opt input:disabled{cursor:not-allowed}'
    + '@media (max-width:560px){#rexo-cookie{left:10px;right:10px;bottom:10px;padding:20px}}';
